...
**How to read performance:** the model is designed for group-level review rather than individual student forecasting. Individual gain R-squared is 0.097, while aggregate fit is stronger for teacher and course means. Use the baseline to compare group-level actual growth with expected growth.
